      ...
      <main id="home" className="flex flex-col md:flex-row items-center justify-center w-full px-4 md:px-52 pb-4 md:pb-24 md:pt-32 pt-24 mt-14 md:mt-0 z-10">
        <section className="flex-1 mr-28 md:text-left mt-10 md:mt-0 relative"
          ...
          <p className="text-nase sm:text-lg md:text-lg text-gray-200 mb-6">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Ullam, at omnis distinctio, incidunt eveniet aliquam consectetur nam minus laborum provident saepe blanditiis odit quam cumque, dolorum perspiciatis ducimus? Vitae, laborum?
          </p>
